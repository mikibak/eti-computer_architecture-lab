...
public _main
	...
	.code
		...
		wyswietl_EAX_hex PROC
			...
			;wykrywanie zer nieznacz¹cych
			mov ecx, 8
			mov edx, 0
			ptl_spacjokonwersja:
				inc edx
				cmp byte PTR [edi][edx], 30h ;sprawdzenie, czy to znak '0'
				je zamien_na_spacje
				jmp wyswietl_heksy ;gdy napotkano cyfrê ró¿n¹ od '0' nie zamieniaæ dalej
			loop ptl_spacjokonwersja
			...
			zamien_na_spacje: 
			mov byte PTR [edi][edx], 20H ;podmiana na spacjê
			jmp ptl_spacjokonwersja
